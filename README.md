...
- Average travel package cost by travel type  
- Monthly booking trend analysis  
- Booking distribution by age group  
...
- **Top Destinations:**  
  Maui (17 bookings) and Dubai (16 bookings) are the most popular destinations, followed by Kyoto and Bali.

- **Travel Package Cost:**  
  Yacht and Villa packages have the highest average costs (~8.6K), while Tours are the most affordable (~6.7K).

- **Booking Trends:**  
  Bookings dropped from **46 in January** to **32 in February**, then increased again to **42 in March**, indicating a seasonal dip followed by recovery.
